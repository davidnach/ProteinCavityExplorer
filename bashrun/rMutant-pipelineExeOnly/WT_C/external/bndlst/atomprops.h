...
/* A new atom must also be added to the function getAtomName() and   */
...
atomProp AtomTbl[NUMATOMTYPES] = { /* noAtom must be first */
   ...
   {atomF,       9, "F",    1.30, 1.30, 0.58, "green", 0},
   {atomCl,     17, "Cl",   1.77, 1.77, 0.99, "green", 0},
   {atomBr,     35, "Br",   1.95, 1.95, 1.14, "brown", 0},
   {atomI,      53, "I",    2.10, 2.10, 1.33, "brown", 0},
