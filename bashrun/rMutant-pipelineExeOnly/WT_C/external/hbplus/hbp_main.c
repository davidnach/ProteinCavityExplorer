...
/*    printf("DEBUG: Parsed fname\n");*/
	...
	{
//	    printf("the output file name is: %s", outfn);
...
int main(int argc, char * argv[])
{
    ...
    //    printf("the value of argv is %s", argv[1]);
    printf("Invoking HBPlus to calculate HBonds");
#ifdef __unix
{
    ...
    // NKF - Sept 30, 2009
    // Fixed a major bug from running hbplus in php
    // see http://rigdyn.linkage.cs.umass.edu/mantis/view.php?id=12
    // for details
...
*/  
    ...
    printf("HBPlus calculation Criteria:\n\n");
    if(nnbflg)
